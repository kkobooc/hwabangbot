...
-- -----------------------------------------------------
-- 8. processed_content_embeddings: 벡터 임베딩
-- -----------------------------------------------------
...
CREATE INDEX IF NOT EXISTS idx_processed_content_embeddings_embedding
    ON processed_content_embeddings USING ivfflat (embedding vector_cosine_ops) WITH (lists = 100);

COMMENT ON TABLE processed_content_embeddings IS '콘텐츠 벡터 임베딩 (pgvector)';
